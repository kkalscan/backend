...
object FeatureSearchCatalog {
    val items: List<FeatureSearchItemRecord> = listOf(
        ...
        FeatureSearchItemRecord("food_search", "Найти продукт", "Добавить блюдо из каталога", "продукт,каталог,найти,борщ,творог,добавить еду,без фото", "kkalscan://food-search", "search", 15),
